...
public class Menu {
	...
	public static void main(String[] args) {
		...
		ContaCorrente cc1 = new ContaCorrente(contas.gerarNumero(), 123, 1, "Arkimedes Junior", 1000f, 100.0f);
		contas.cadastrar(cc1);

		ContaCorrente cc2 = new ContaCorrente(contas.gerarNumero(), 124, 1, "Amanda Freire", 2000f, 100.0f);
		contas.atualizar(cc2);

		ContaPoupanca cp1 = new ContaPoupanca(contas.gerarNumero(), 125, 2, "Hellen Freire", 4000f, 12);
		contas.cadastrar(cp1);

		ContaPoupanca cp2 = new ContaPoupanca(contas.gerarNumero(), 125, 2, "Marcos Vinicius", 8000f, 15);
		...
		while (true) {
			...
			System.out.println("************************************************");
			System.out.println("                                                ");
			System.out.println("          BANCO MERCADO DIAS                    ");
			System.out.println("                                                ");
			System.out.println("************************************************");
			System.out.println("                                                ");
			...
			if (opcao == 9) {
				System.out.println(Cores.TEXT_WHITE_BOLD + "\nBanco Mercado Dias - O seu futuro começa aqui!");
				sobre();
				leia.close();
				System.exit(0);
	...
	public static void sobre() {
		...
		System.out.println("Generation Brasil - arkimedesjuniuor01@gmail.com");
		System.out.println("https://github.com/ArkimedesJunior/Conta-Bancaria");
		System.out.println("*********************************************************");
	}
	...
	public static void keyPress() {
		try {
			...
			System.out.println("Voce pressionou uma tecla diferente de entrar!");
		}
	}
